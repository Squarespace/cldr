...
public class CodeGenerator {
  ...
  private static void createLocales(
      TypeSpec.Builder type, List<LocaleID> defaultContent, Set<LocaleID> available) {

    for (LocaleID locale : available) {
      addLocaleField(type, locale);
    }
   ...
   */
  private static void addLocaleField(TypeSpec.Builder type, LocaleID locale) {
